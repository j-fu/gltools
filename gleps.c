static char *rcsid= "$Id: gleps.c,v 2.25 2001/03/02 16:38:04 fuhrmann Exp $";
			     ...
			     GLfloat * loc)
{
  ...
  switch (token) 
	...
	steps = 0;
      ...
      PutCrd(file,vertex[0].red*colfac);
      PutCrd(file,vertex[0].green*colfac);
      PutCrd(file,vertex[0].blue*colfac);
      PutCmd(file,"C\n");
			    ...
			    BBox *bbox)
{
  ...
  fprintf(file,"%%%%Creator: gltools/gleps.c $Revision: 2.25 $ (c) Juergen Fuhrmann <fuhrmann@wias-berlin.de> \n");
...
/*
 * $Log: gleps.c,v $
 * Revision 2.25  2001/03/02 16:38:04  fuhrmann
 * Arbeiten fuer Fuelcell/Juelich
 *
 * Revision 2.24  2000/12/10 22:58:09  fuhrmann
 * gleps bug
 * flglwin proto works
 *
 * Revision 2.23  2000/11/22 15:20:49  fuhrmann
 * ICE hack
 * 1 mpeg/eps per variation
 * variation[i]-> variationi
 * bias=... option
 *
 * Revision 2.22  2000/10/31 17:31:55  fuhrmann
 * points in polyx2sg
 * fixed clear in gleps
 *
 * Revision 2.21  2000/10/26 16:10:02  fuhrmann
 * *** empty log message ***
 *
 * Revision 2.20  2000/10/26 16:07:57  fuhrmann
 * *** empty log message ***
 *
 * Revision 2.19  2000/10/26 16:07:34  fuhrmann
 * gleps revision
 *
 * Revision 2.18  2000/10/25 10:49:59  fuhrmann
 * crop stuff for graphics
 *
 * Revision 2.17  2000/10/19 09:54:59  fuhrmann
 * scl graphics stuff
 *
 * Revision 2.16  2000/08/22 09:36:39  fuhrmann
 * removed "*" print
 *
 * Revision 2.15  2000/01/13 17:36:41  fuhrmann
 * optmized ps output
 *
 * Revision 2.14  2000/01/11 17:04:49  fuhrmann
 * Iljas Aenderungen wieder 'raus
 *
 * Revision 2.13  2000/01/11 16:50:39  schmelze
 * *** empty log message ***
 *
 * Revision 2.12  1999/11/04 17:16:09  philip
 * string memory bug in glwin
 * roundoff error in colors in gleps
 *
 * Revision 2.11  1999/11/01 18:31:42  fuhrmann
 * linewidth 1->0
 *
 * Revision 2.10  1999/09/17 16:35:01  fuhrmann
 * feedback stuff war kaputtrepariert...
 *
 * Revision 2.9  1999/09/15 16:16:24  fuhrmann
 * size_t for feedback buffer
 * file !=NULL check for dump files
 *
 * Revision 2.8  1999/08/04 13:03:43  fuhrmann
 * some hacks concerning feedback
 *
 * Revision 2.7  1999/07/02 10:38:04  fuhrmann
 * Mesa bug neutralized, gleps reference taken out of glwin
 *
 * Revision 2.6  1999/07/01 17:09:12  fuhrmann
 * tested portability (Linux, IRIX, DUNIX)
 *
 * Revision 2.5  1999/06/30 13:14:14  fuhrmann
 * fontscale bug removed
 *
 * Revision 2.4  1999/06/30 13:07:50  fuhrmann
 * font size stuff
 *
 * Revision 2.3  1999/06/30 10:55:45  fuhrmann
 * no exit at token errors
 *
 * Revision 2.2  1999/06/30 10:27:25  fuhrmann
 * some bells &whistles in feedback stuff
 *
 * Revision 2.1  1999/06/29 17:56:23  fuhrmann
